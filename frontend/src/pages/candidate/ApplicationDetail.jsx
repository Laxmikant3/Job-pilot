    ...
    <div className="p-6 border-b">
      ...
      {user?.role === "candidate" && (
        <div className="mt-2">
          ...
          <div className="bg-blue-500 border border-blue-200 rounded-md p-2 text-xs text-blue-700">
        ...
        {application.messages.length > 0 ? (
          application.messages.map((msg, index) => (
            ...
            >
              ...
              <div>
                <div
                  className={`max-w-md p-3 rounded-lg border ${
                    msg.sender ===
                    (user.role === "company" ? "company" : "candidate")
                      ? "bg-primary text-white ml-auto border-primary-600"
                      : msg.sender === "system"
